...
wk.add(
  {
    ...
    },
    {
      "<C-c>",
      group = "+Coding Nav",
      { "<C-c><C-d>",   "<cmd>lua vim.lsp.buf.declaration()<CR>",    desc = "Jump to declaration" },
      { "<C-c><C-S-d>", "<cmd>lua vim.lsp.buf.definition()<CR>",     desc = "Jump to definition" },
      { "<C-c><C-i>",   "<cmd>lua vim.lsp.buf.implementation()<CR>", desc = "Jump to implementation" },
      { "<C-c><C-n>",   ":lua vim.diagnostic.goto_next()<CR>",       desc = "Next error" },
      { "<C-c><C-p>",   ":lua vim.diagnostic.goto_prev()<CR>",       desc = "Previous error" }
    },
    {
      "C-h",
      group = "+Coding Helper",
      { "<C-h><C-h>", "<cmd>lua vim.lsp.buf.hover()<CR>",          desc = "Lsp hover" },
      { "<C-h><C-s>", "<cmd>lua vim.lsp.buf.signature_help()<CR>", desc = "Signature help" }
    },
...

    {
      ...
      { "<Leader>br", ts.git_bcommits_range,                             desc = "Commits of a range of lines" },
...

    {
      "<C-x>",
      group = "+Word",
      { "<C-x><C-s>",   ts.spell_suggest,              desc = "Spell suggestions" },
      { "<C-x><C-c>",   ts.git_bcommits_range,         desc = "Commits in range",      mode = "v" },
      { "<C-x><C-v>",   ":FzfLua grep_visual<CR>",     desc = "Grep selected",         mode = "v" },
      { "<C-x><C-S-w>", ":FzfLua grep_cWORD<CR>",      desc = "Grep WORD under cursor" },
      { "<C-x><C-w>",   ":FzfLua grep_cword<CR>",      desc = "Grep word under cursor" },
      { "<C-x><C-S-t>", ":FzfLua tags_grep_cWORD<CR>", desc = "Grep WORD under cursor" },
      { "<C-x><C-t>",   ":FzfLua tags_grep_cword<CR>", desc = "Grep word under cursor" },
      {
        group = "+Tabs",
